...
.header { font-size: 36rpx; font-weight: 700; margin-bottom: 24rpx; }
.timeline { position: relative; margin-left: 20rpx; }
.timeline::before { content:''; position: absolute; left: 8rpx; top: 0; bottom: 0; width: 2rpx; background: #e5e5ea; }
.time-item { position: relative; display:flex; align-items:flex-start; margin-bottom: 20rpx; }
.dot { width: 14rpx; height: 14rpx; border-radius: 7rpx; background:#007AFF; margin-right: 16rpx; position: relative; top: 16rpx; }
.card { flex:1; background:#fff; border: 1rpx solid #eee; border-radius: 12rpx; padding: 16rpx; box-shadow: 0 6rpx 12rpx rgba(0,0,0,0.05); }
